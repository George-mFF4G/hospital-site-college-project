            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    <label for="name" class="col-md-3 col-form-label">Age</label>
                    <div class="col-md-9">
                      <p class="form-control-plaintext text-muted">{{$contact->age}}</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="company_id" class="col-md-3 col-form-label">description</label>
                    <div class="col-md-9">
                      <p class="form-control-plaintext text-muted">{{$contact->description}}</p>
                    </div>
                  </div>
                  <hr>
