...
<div class="overlay">
<div id="covid">
  <h1 class="cov">< Important tips for preventing corona virus ></h1>
 <div class="pic1">
      <h2 class="advise1"> (1) Take steps to protect yourself </h2><br>
      <h4 class="advise11">  * Put distance between yourself and other people </h4>
...
<g id="body">
  ...
  <g class="head">
   ...
   <div class="pic2">
      <div class="cont2">
      <h2 class="advise2"> (2) Wash your hands with soap and water always </h2><br>
      <h4 class="advise22">*Avoid touching your eyes, nose, and mouth with unwashed hands </h4>
      </div>
...
<g id="body">
  ...
  <g class="head">
   ...
   <div class="pic3">
       <h2 class="advise3"> (3) Avoid close contact </h2><br>
        <h4 class="advise33">*virus is thought to spread mainly from person-to-person </h4>
      <img  class="img3" src="images/pic3.png" >
       <svg id="covido-19" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 200" enable-background="new 0 0 200 200" xml:space="preserve">
