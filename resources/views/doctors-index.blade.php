              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col">
                        <form action="{{ Route('doctors.search') }}" method="POST" align="center" style="margin-top: 10px;">
                          @csrf
                          ...
                          <input type="submit" name="submit" class="btn btn-info" value="Filter" style="    width: 30%;border-radius: 10px;">
                      </form>
                      </div>
                      {{-- <div class="col">
